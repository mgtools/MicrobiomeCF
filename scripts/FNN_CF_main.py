"""
Main script to train and evaluate the FNN encoder with confounder control.
"""
...
from src.FNN_CF_models import GAN, PearsonCorrelationLoss
...
def main():
    ...
    for the FNN encoder model with confounder-free classification.
    """
    ...
    #   Output directory    #
    # --------------------- #
    output_dir = 'Results/FNN_encoder_confounder_free_plots'
